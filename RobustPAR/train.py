...
clip_model, ViT_preprocess = clip.load("ViT-L/14", device=device,download_root='/media/a1/E10/RobustPAR/data/pretrain_model')
...
def main(args):
    ...
    for name, param in model.named_parameters():
        ...
        elif any(keyword in name for keyword in args.mmformer_update_parameters1):
            mm_params1 += [{
                "params": [param],
                "lr": args.lr1,
                "weight_decay": args.weight_decay
    ...
    count_parameters(model, clip_model, args.mmformer_update_parameters + args.mmformer_update_parameters1,args.clip_update_parameters)
    ...
    optimizer1 = optim.SGD(mm_params1, args.lr1, momentum=0.9, weight_decay=args.weight_decay)
    scheduler1 = create_scheduler(optimizer1, num_epochs=epoch_num, lr=args.lr1, warmup_t=5)
...
def trainer(epoch, model, clip_model, train_loader, valid_loader, criterion, optimizer, scheduler,prompt_scheduler,prompt_optimizer,args,path,optimizer1, scheduler1):
    ...
    for i in range(1, epoch+1):
        ...
        if i%5==0:
            ...
            print(f'max_ma:{max_ma:.4f},max_f1:{max_f1:.4f}')
