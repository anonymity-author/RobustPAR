...
class Transformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.VorT==True:
            ...
            all_class = None
            if args.use_div:
                all_class = torch.stack([x[0 if idx == 0 else self.div_prompt_num * idx + idx + 1 - 1] for idx in range(args.div_num + 1)]).permute(1, 0, 2)
    ...
    def build_visual_mask(self):
        ...
        for row in range(length):
            ...
            if row in masked_row :
                ...
                #no_mask: 1 55->55+80  2 55+48->55+48+96 3 55+112->55+112+96 4 55+176+80
