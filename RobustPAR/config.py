...
def argument_parser():
    ...
    parser.add_argument("--use_div",default=True, action='store_true')
    parser.add_argument("--use_vismask",default=True, action='store_true')
    parser.add_argument("--use_GL", default=True,action='store_true')
    parser.add_argument("--use_textprompt", default=True,action='store_true')
    parser.add_argument("--use_mm_former",default=True, action='store_true')
    ...
    parser.add_argument("--mmformer_update_parameters", type=list, default=["word_embed", "weight_layer0", "bn0", "norm00","blocks0.0.norm"])
    parser.add_argument("--mmformer_update_parameters1", type=list, default=["weight_layer1","attn.in_proj","norm11","norm22","bn1","attn.out_proj","vit1","vit2"])
